...
public class PlayerProfile {
    ...
    public void sendStats(@Nonnull CommandSender sender) {
        ...
        sender.sendMessage("");
        sender.sendMessage(ChatColors.color("&7玩家统计: &b" + name));
        sender.sendMessage("");
        sender.sendMessage(ChatColors.color("&7标题: " + ChatColor.AQUA + getTitle()));
        ...
        sender.sendMessage(ChatColors.color("&7已花费经验等级: " + ChatColor.AQUA + levels));
    }
